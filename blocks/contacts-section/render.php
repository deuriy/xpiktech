              ...
              <div class="contact-block__btn-wrapper<?php echo $contact_type === 'telegram' ? ' contact-block__btn-wrapper--two-col' : '' ?>">
                <?php if ($contact_block['button']['url'] || $contact_block['button']['text']): ?>
                  <?php if ($contact_block['contact_type'] === 'telegram'): ?>
                    <a href="<?php echo esc_url('https://t.me/' . $contact_block['username']) ?>" class="<?php echo $btn_class ?>" target="_blank" rel="nofollow">
                      <?php echo esc_html($contact_block['button']['text']) ?>
                    </a>
                  <?php elseif ($contact_block['contact_type'] === 'email'): ?>
                    <a href="<?php echo esc_url('mailto:' . $contact_block['email']) ?>" class="<?php echo $btn_class ?>" target="_blank" rel="nofollow">
                      <?php echo esc_html($contact_block['button']['text']) ?>
                    </a>
                  <?php else: ?>
                    <a href="<?php echo esc_url($contact_block['button']['url']) ?>" class="<?php echo $btn_class ?>" target="_blank" rel="nofollow">
                      <?php echo esc_html($contact_block['button']['text']) ?>
                    </a>
                  <?php endif ?>
