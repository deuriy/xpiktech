...
$class_name = 'what-we-build-section what-we-build-section--v2';
...
<section <?php echo esc_attr($anchor); ?>class="<?php echo esc_attr($class_name); ?>">
  <div class="container">
    <div class="what-we-build-section__container">
      <?php if ($title): ?>
        <div class="what-we-build-section__title-wrapper">
      ...
      <?php if ($items): ?>
        <ul class="what-we-build-section__items">
          <?php foreach ($items as $key => $item): ?>
            <li class="how-we-work-block how-we-work-block--v2 what-we-build-section__item">
              <?php if ($item['icon']): ?>
